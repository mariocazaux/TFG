...
2. **Optional: critical dependencies** — e.g. can open a **database** connection or run a trivial query _if_ you accept that DB blips mark the whole service unhealthy (often desirable for strict readiness).
